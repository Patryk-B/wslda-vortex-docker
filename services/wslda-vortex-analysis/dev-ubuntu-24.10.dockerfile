...
ARG ARG_APP_ANALYSIS_CODENAME="dev-ubuntu-24.10"
...
ARG ARG_APP_ANALYSIS_CONFIGDIR_HOST="./.${ARG_APP_ANALYSIS_CODENAME}/.config"
ARG ARG_APP_ANALYSIS_CONFIGDIR_CNTR="/.${ARG_APP_ANALYSIS_CODENAME}/.config"
ARG ARG_APP_ANALYSIS_TEMPLATEDIR_HOST="./.${ARG_APP_ANALYSIS_CODENAME}/.templates"
ARG ARG_APP_ANALYSIS_TEMPLATEDIR_CNTR="/.${ARG_APP_ANALYSIS_CODENAME}/.templates"
ARG ARG_APP_ANALYSIS_RESULTS_DATA_DIR_HOST
ARG ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR
ARG ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_HOST
ARG ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_CNTR
...
RUN echo ""\
    ...
    && echo "- ARG_APP_ANALYSIS_CODENAME: .................... ${ARG_APP_ANALYSIS_CODENAME}"\
    ...
    && echo "- ARG_APP_ANALYSIS_RESULTS_DATA_DIR_HOST: ....... ${ARG_APP_ANALYSIS_RESULTS_DATA_DIR_HOST}"\
    && echo "- ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR: ....... ${ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR}"\
    && echo "- ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_HOST: ... ${ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_HOST}"\
    && echo "- ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_CNTR: ... ${ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_CNTR}"\
    && echo ""\
...
# mkdir "${ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR}":
RUN mkdir -p "${ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR}"
...
ENV ENV_APP_ANALYSIS_RESULTS_DATA_DIR="${ARG_APP_ANALYSIS_RESULTS_DATA_DIR_CNTR}"
ENV ENV_APP_ANALYSIS_RESULTS_ANALYSIS_DIR="${ARG_APP_ANALYSIS_RESULTS_ANALYSIS_DIR_CNTR}"
...
CMD /usr/local/bin/entrypoint\
    ...
    --app-analysis-results-data-dir "${ENV_APP_ANALYSIS_RESULTS_DATA_DIR}"\
    --app-analysis-results-analysis-dir "${ENV_APP_ANALYSIS_RESULTS_ANALYSIS_DIR}"
